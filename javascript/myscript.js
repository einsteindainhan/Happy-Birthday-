...
document.querySelector('.Description .modal-body').innerHTML = 'Cậu đang nhìn tớ đó! Ngại ghê🤭🤭🤭 <i class="fas fa-heart"></i> ';
var author = document.querySelector('.author .me');author.style.opacity = "0.5";

author.innerHTML = "Mọi thắc mắc cậu có thể liên hệ<a href='https://www.facebook.com/chu.minhanh.90?mibextid=ZbWKwL'>Chu Minh Anh<a>";
